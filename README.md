...
Restricting service binding to resources within the same namespace is strongly **RECOMMENDED**.  However, if implemented, cross-namespace service binding **SHOULD** be secured appropriately by the implementor to prevent attacks like privilege escalation and secret enumeration.
